...
app.post('/Userbpayment', checkAuthenticated,async (req, res) => {
...
app.post('/Usermpayment', checkAuthenticated, async (req, res) => {
  const teller = req.user.tellertype;
  const Branch = req.user.branch;
...
app.post('/UserInputs1',checkAuthenticated, async (req, res) => {
...
app.post('/UserInputs2',checkAuthenticated, async (req, res) => {
  const type =req.user.tellertype;
  const location = req.user.branch;
...
app.post('/UserInputs3',checkAuthenticated, async (req, res) => {
  const type =req.user.tellertype;
  const location = req.user.branch;
  const userId = req.user.name;
...
app.post('/Spayment',checkAuthenticated, async (req, res) => {
  const username = req.user.name;
...
app.post('/SuperuserInput1',checkAuthenticated, async (req, res) => {
...
app.post('/SuperuserInput2',checkAuthenticated, async (req, res) => {
  const username = req.user.usertype;
  const medium = req.body.paymenttype;
...
app.post('/SuperuserInput3',checkAuthenticated, async (req, res) => {
  const username = req.user.usertype;
  const branch = req.body.branch;
  const Teller = req.body.teller;
...
app.post('/SuperuserInput5',checkAuthenticated, async (req, res) => {
  const username = req.user.usertype;
...
app.post('/SuperuserInput4',checkAuthenticated, async (req, res) => {
  const username = req.user.usertype;
  const Account = req.body.Account;
...
app.post('/SuperuserInput6',checkAuthenticated, async (req, res) => {
  const username = req.user.usertype;
...
app.post('/SuperuserInput7',checkAuthenticated, async (req, res) => {
  const username = req.user.usertype;
...
app.post('/susutransform',checkAuthenticated, async (req, res) => {
  const type =req.user.tellertype;
  const location = req.user.branch;
  const username = req.user.name;
...
app.post('/UserOtherTrans',checkAuthenticated, async (req, res) => {
  const type =req.user.tellertype;
  const location = req.user.branch;
  const username = req.user.name;
